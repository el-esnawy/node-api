      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // alert(error.response.data.message);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZXNuYXd5IiwiYSI6ImNrcDJsY2J3eTFmZjgycG54eXRkMGN6ZzEifQ.wT5GKjRUwbaNjicp0zQdaw';
  ...
  var loadMap = function loadMap(entries, observer) {
  ...
  var observer = new IntersectionObserver(loadMap, mapOptions);
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alerts.showAlert)('success', "".concat(type.toLowerCase(), " updated successfully"));
            }
...
var stripe = Stripe("pk_test_51IxcZ3BNUyYQrrRi7svzP2kML0oxbV8uSDhZdS1LO4PHg7hiIgj99LkwlQpYjORMH6f4aeHIBAIC2FIZkpAwQDNC005Guspi6e");
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _login.login)(emailValue, passwordValue);
  });
}

if (mapTarget) {
  var locations = JSON.parse(mapTarget.dataset.locations);
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var passwordCurrent, password, passwordConfirm, respone;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
